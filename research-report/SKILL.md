...
description: Summarize structured research results into a markdown report that covers all defined fields and skips uncertain values. Use when converting outline-driven JSON research outputs into a readable report, and keep prompts and confirmations portable across agents.
---
...
If the user already specified summary fields, use them.
Otherwise ask a short plain-text question listing a few suitable field options discovered from the JSON results.
